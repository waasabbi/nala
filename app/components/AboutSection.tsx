          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-[#f5f0eb] p-4 rounded-xl text-center">
                ...
                <h3 className="text-sm font-medium">Clean Ingredients</h3>
              </div>
              ...
              <div className="bg-[#f5f0eb] p-4 rounded-xl text-center">
                ...
                <h3 className="text-sm font-medium">Sustainable Beauty</h3>
              </div>
              ...
              <div className="bg-[#f5f0eb] p-4 rounded-xl text-center">
                ...
                <h3 className="text-sm font-medium">Dermatologist-Approved</h3>
              </div>
            </div>
          </div>
        </div>
